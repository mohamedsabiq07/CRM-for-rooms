...
export const INITIAL_ROOMS: RoomUnit[] = [
  {
    ...
    paymentTerms: 'Quarterly',
    realEstateName: 'Vienna Real Estate Management',
    realEstatePhone: '+971 4 399 1122',
    ejariNumber: 'EJR-2026-1039',
  ...
  },
  {
    ...
    buildingId: 'bld-vienna',
    roomNumber: '304',
    roomType: 'Partition Flat (Flat 304)',
    capacity: 7, // Accommodates 7
    actualRentAnnual: 36000,
    paymentTerms: 'Quarterly',
    realEstateName: 'Vienna Real Estate Management',
    realEstatePhone: '+971 4 399 1122',
    ejariNumber: 'EJR-2026-3047',
    securityDepositToOwner: 3000,
    contractStartDate: '01.01.2026',
    contractEndDate: '31.12.2026',
    notes: 'Flat 304 accommodates 7 beds, currently 6 occupied, 1 vacant',
    dewaBill: {
      provider: 'DEWA',
      accountNumber: '2201948575',
      amount: 720,
      dueDate: '10.09.2026',
      status: 'Due',
      notes: 'Electricity & Water'
  ...
  },
  {
    ...
    capacity: 8,
    actualRentAnnual: 38000,
    paymentTerms: 'Quarterly',
    realEstateName: 'Al Waleed Real Estate LLC',
    realEstatePhone: '+971 4 330 2200',
    ejariNumber: 'EJR-2026-2041',
    securityDepositToOwner: 3100,
    contractStartDate: '01.01.2026',
    contractEndDate: '31.12.2026',
    dewaBill: {
      provider: 'DEWA',
  ...
  },
  {
    ...
    capacity: 10,
    actualRentAnnual: 40000,
    paymentTerms: 'Quarterly',
    realEstateName: 'Al Waleed Real Estate LLC',
    realEstatePhone: '+971 4 330 2200',
    ejariNumber: 'EJR-2026-4082',
    securityDepositToOwner: 3300,
    contractStartDate: '01.01.2026',
    contractEndDate: '31.12.2026',
    dewaBill: {
      provider: 'DEWA',
...
export const INITIAL_TENANTS: Tenant[] = [
  ...
  // --- VIENNA BUILDING - FLAT 304 (Accommodates 7, 6 Active Tenants, 1 Vacant Bed) ---
  {
    id: 't-304-1',
    sno: 1,
    buildingId: 'bld-vienna',
    roomId: 'room-vienna-304',
    flatId: 'bld-vienna',
    name: 'Amina',
    place: 'Malayali',
    phone: '+971501112201',
    deposit: 300,
    depositNote: 'Security advance',
...
export const INITIAL_EXPENSES: ExpenseItem[] = [
  {
    ...
    roomId: 'room-vienna-103',
    buildingId: 'bld-vienna',
    title: 'AC Gas Refill & Compressor Deep Clean',
    category: 'AC Maintenance & Repair',
    amount: 450,
    date: '15.07.2026',
    paidBy: 'Cash',
    invoiceRef: 'INV-AC-9901',
    notes: 'Technician repaired hall split unit'
  },
  {
    id: 'exp-2',
    roomId: 'room-vienna-103',
    buildingId: 'bld-vienna',
    title: 'LPG Cooking Gas Cylinder Replacement',
    category: 'Gas / LPG Cylinder',
    amount: 120,
    date: '02.08.2026',
    paidBy: 'Cash',
    invoiceRef: 'GAS-4412',
    notes: 'Kitchen blue cylinder'
  },
  {
    id: 'exp-3',
    roomId: 'room-vienna-103',
    buildingId: 'bld-vienna',
    title: 'Monthly Deep Cleaning & Trash Bags/Detergents',
    category: 'Cleaning & Maid Service',
    amount: 250,
    date: '20.08.2026',
    paidBy: 'Cash',
    notes: 'Maid 4 hours cleaning'
  },
  {
    id: 'exp-4',
    roomId: 'room-vienna-304',
    buildingId: 'bld-vienna',
    title: 'Plumbing Washbasin Leak & Trap Repair',
    category: 'Plumbing & Electrical',
    amount: 180,
    date: '10.06.2026',
    paidBy: 'Cash',
    invoiceRef: 'PLUMB-104',
    notes: 'Replaced washbasin mixer pipe'
  },
  {
    id: 'exp-5',
    roomId: 'room-vienna-304',
    buildingId: 'bld-vienna',
    title: 'Pest Control & Bedbug Spraying Service',
    category: 'Pest Control',
    amount: 300,
    date: '05.07.2026',
    paidBy: 'Cash',
    invoiceRef: 'PEST-881',
    notes: 'Full flat treatment'
  },
  {
    id: 'exp-6',
    roomId: 'room-vienna-103',
    buildingId: 'bld-vienna',
    title: 'Ejari Registration & Tenancy Contract Fee',
    category: 'Ejari Registration Fee',
    amount: 220,
    date: '05.01.2026',
    paidBy: 'Card',
    invoiceRef: 'EJR-GOV-1039',
    notes: 'Annual Ejari typing center fee'
  }
];
